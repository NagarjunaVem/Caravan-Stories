...
const Register = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-zinc-950">
            ...
            >
                <h1 className="text-zinc-900 dark:text-white text-3xl mt-10 font-medium">Register</h1>
                ...
                <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-3 mb-11">Already have an account?{' '}
                    <Link
                        to="/login"
