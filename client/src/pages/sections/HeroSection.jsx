...
const HeroSection = () => {
    ...
    const { isLoggedIn, ticketSummary, backendUrl, userData } = useContext(AppContext)
    ...
    useEffect(() => {
        ...
        if (isLoggedIn && userData?.role === 'admin') {
            ...
            // ✅ For non-admin users, fetch from public stats endpoint
            fetchPublicStats()
        }
    ...
    const fetchEmployeeCount = async () => {
        try {
            ...
            console.log('Admin employee fetch failed, trying public stats')
            fetchPublicStats()
        }
    }
    ...
    const fetchPublicStats = async () => {
        try {
            ...
            setEmployeeCount(0) // Default to 0
        }
    }
                ...
                <div className="text-center max-w-2xl mx-auto">
                    <div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-6 items-center mt-12">
                            ...
                            <div className="flex flex-col items-center text-center">
                                <h5 className="font-bold text-2xl text-indigo-600 mb-2">
                                    {employeeCount > 0 ? employeeCount : '50+'}
                                </h5>
